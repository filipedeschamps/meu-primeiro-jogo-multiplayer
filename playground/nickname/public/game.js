...
export default function createGame() {
  ...
  function addPlayer(command) {
    ...
    const nickname = 'nickname' in command ? command.nickname : command.playerId
    const score = 0
  ...
  function setNickname({ nickname, playerId }) {
    state.players[playerId].nickname = nickname || playerId
    notifyAll({
